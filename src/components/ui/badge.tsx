  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        avaible:
          "border-transparent bg-green-600 hover:bg-green-800 cursor-pointer",
        unvaible:
          "border-transparent bg-red-600 hover:bg-red-800 cursor-pointer",
        alocate:
          "border-transparent bg-orange-500 hover:bg-orenge-800 cursor-pointer",
      },
    },
    defaultVariants: {
      variant: "default",
